...
3. add and install esp8266 board manager (http://arduino.esp8266.com/stable/package_esp8266com_index.json & https://github.com/esp8266/Arduino?tab=readme-ov-file#installing-with-boards-manager)
